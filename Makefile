...
out : compclass.cpp
	c++ -std=c++11 -g compclass.cpp  -I/usr/local/include/ap_fixed $(gtk_pkg) -framework CoreMIDI -framework CoreFoundation -framework CoreAudio -framework AudioUnit -framework CoreServices -o out
clean : 
